python negbio/negbio_pipeline.py section_split --pattern patterns/section_titles_cxr8.txt --output $OUTPUT_DIR/sections $INPUT_FILES --workers=6
...
python negbio/negbio_pipeline.py dner_regex --phrases patterns/chexpert_phrases.yml --output $OUTPUT_DIR/dner $OUTPUT_DIR/ud/* --suffix=.chexpert-regex.xml --workers=6
